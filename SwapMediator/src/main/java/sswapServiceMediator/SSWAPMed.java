...
public class SSWAPMed {
    ...
    public void sendRequest(String str) {
        ...
        try {
            ...
            System.out.println("HTTP " + +responseCode + "Error executing httpGet: " + e);
        }

        RDG rdg = null;
        try {
            URI uri = new URI(serviceUrl);
            rdg = SSWAP.getResourceGraph(response, RDG.class, uri);
        ...
        System.out.println("Resource online description: " + resource.getOneLineDescription());
